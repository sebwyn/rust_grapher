...
//create a triangle pipeline from a file where the vertex function is vs_main and fragment is fs_main
...
pub struct State {
    ...
    render_pipelines: [BasicRenderPipeline; 2],
...
impl State {
    ...
    pub async fn new(window: &Window) -> Self {
        ...
        let diffuse_bytes = include_bytes!("astronaut_on_horse.png");
        ...
        let render_pipeline_1 = BasicRenderPipeline::new(
            &config,
            &device,
            include_str!("shader_gay.wgsl"),
            &texture_bind_group_layout,
        );
        let render_pipeline_2 = BasicRenderPipeline::new(
            &config,
            &device,
        ...
        let pentagon = Model::new(&device, PENTA_VERTICES, PENTA_INDICES);
        ...
        Self {
            ...
            current_pipeline: false, //use the first render pipeline
            model: pentagon,
            clear_color: wgpu::Color {
                r: 0.3,
                g: 0.2,
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            render_pass.set_pipeline(
                &self.render_pipelines[self.current_pipeline as usize].render_pipeline,
            );
